    ...
    <div className="theory">
      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <p className="hero-subtitle">Tạp chí VNR - Số tháng 10/2025</p>
          <p className="hero-date">"Lừng lẫy năm châu, chấn động địa cầu"</p>
        </div>
      </section>
      ...
      <div className="theory-timeline">
        ...
        <section
          ref={section2Ref}
          className={`content-section history-section scroll-reveal ${
        ...
        >
          ...
          <div className="content-body">
            <div className="timeline-container">
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  ...
                  <p>
                    ...
                    trung lực lượng đánh chiếm Điện Biên Phủ, biến nơi đây thành
                    "pháo đài bất khả xâm phạm" để kiểm soát Tây Bắc và chuẩn bị
                    phản công lớn.
                  </p>
                  <div className="highlight-box">
                    <strong>🎖️ Âm mưu của Pháp:</strong> Tập trung 16 tiểu đoàn
                    tinh nhuệ, xây dựng 49 cứ điểm kiên cố, có hỏa lực mạnh và
                    được Mỹ viện trợ.
                  </div>
                </div>
              </div>
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  ...
                  <p>
                    Tháng 9/1953, Bộ Chính trị họp dưới sự chủ trì của Chủ tịch
                    Hồ Chí Minh, quyết định mở chiến dịch Điện Biên Phủ với
                    phương châm:
                  </p>
                  <div className="strategy-box">
                    <div className="strategy-item">
                      <span className="icon">⚔️</span>
                      <strong>Tập trung lực lượng:</strong> Tạo ưu thế tuyệt đối
                    </div>
                    <div className="strategy-item">
                      <span className="icon">🎯</span>
                      <strong>Đánh chắc, tiến chắc:</strong> Phương châm của Đại
                  ...
                  <div className="phases">
                    <div className="phase-card">
                      ...
                      <p>
                        ...
                        Lam, Độc Lập, Hồng Cúm. Ta kiểm soát được nhiều điểm cao
                        quan trọng.
                      </p>
                    </div>
                    <div className="phase-card">
                      ...
                      <p>
                        <strong>Rút ngắn vòng vây:</strong> Tiến công cụm trung
                        tâm, phá hủy sân bay, cắt đứt tiếp tế bằng đường không.
                        Địch lâm vào thế bị động hoàn toàn.
                      </p>
                    </div>
                    <div className="phase-card highlight">
                      <h4>Giai đoạn 3 (1-7/5/1954)</h4>
                      <p>
                        <strong>Tổng tiến công và thắng lợi:</strong> Đánh chiếm
                        Mường Thanh, Hồng Cúm, A1. Ngày 7/5, chiếm Đồi A1 và bắt
                        sống Đờ Cát, toàn bộ tập đoàn cứ điểm Điện Biên Phủ sụp
                        đổ!
                      </p>
                    </div>
                  </div>
            ...
            <div className="quote-box special">
              ...
              <p>
                <strong>"Đánh chắc, tiến chắc"</strong> - Phương châm chiến lược
                của Đại tướng Võ Nguyên Giáp đã thể hiện tư duy quân sự sáng
                tạo, linh hoạt, đảm bảo thắng lợi tuyệt đối cho quân ta.
              </p>
            </div>
        ...
        {/* Section 3: Dấu Chân Người Lính */}
        <section
          ref={section3Ref}
          className={`content-section soldier-section scroll-reveal ${
        ...
        >
          ...
          <div className="content-body">
            ...
            <div className="story-content">
              ...
              <p>
                Tô Vĩnh Diện sinh năm 1924 tại xã Nông Trường, huyện Nông Cống,
                tỉnh Thanh Hóa. Từ tuổi thanh niên, anh đã tham gia vào lực
                lượng dân quân, rồi xung phong đi bộ đội vào năm 1949.
              </p>
              ...
              <div className="critical-moment">
                ...
                <div className="moment-box">
                  <p>
                    ...
                    Chuối" rất nguy hiểm. Dây tời kéo khẩu pháo bị đứt, pháo lao
                    tuột xuống dốc.
                  </p>
                  <div className="hero-action">
                    ...
                    <p>
                      ...
                      <strong>dùng thân mình chèn vào càng pháo</strong> để ngăn
                      khẩu pháo nặng hơn 2 tấn tuột xuống vực.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="sacrifice-box">
                ...
                <p>
                  Cảnh tượng ấy khiến đồng đội nghẹn ngào — khẩu pháo được cứu,
                  nhưng Diện đã bị bánh pháo đè trọng thương.
                </p>
              ...
              <div className="legacy-box">
                ...
                <p>
                  ...
                  hùng cao cả nhất của người lính Việt Nam. Khẩu pháo mà anh bảo
                  vệ bằng mạng sống đã tiếp tục góp phần vào chiến thắng vĩ đại
                  tại Điện Biên Phủ.
                </p>
                <p className="lesson">
                  <strong>Bài học:</strong> Tinh thần "thà hy sinh chứ không để
                  mất pháo" thể hiện lòng yêu nước, trách nhiệm và ý chí quyết
                  tâm của người chiến sĩ Việt Nam - sẵn sàng hi sinh vì sự
        ...
        {/* Section 4: Sức Mạnh Của Đảng */}
        <section
          ref={section4Ref}
          className={`content-section party-section scroll-reveal ${
          ...
          <div className="content-body">
            <div className="intro-highlight">
              <p className="lead-text">
                Chiến thắng Điện Biên Phủ năm 1954 là một mốc son chói lọi trong
                lịch sử dân tộc,{" "}
                <strong>"lừng lẫy năm châu, chấn động địa cầu"</strong>. Đằng
                sau chiến thắng vĩ đại ấy là sự lãnh đạo sáng suốt của Đảng Cộng
                sản Việt Nam – nhân tố quyết định dẫn dắt toàn dân tộc đi tới
                thắng lợi cuối cùng.
              </p>
            </div>
            ...
            <div className="leadership-sections">
              <div className="leadership-card">
                ...
                <p>
                  ...
                  Đảng đã họp Bộ Chính trị (9-1953) dưới sự chủ trì của Chủ tịch
                  Hồ Chí Minh để xác định đường lối kháng chiến đúng đắn:
                </p>
                ...
                <p className="analysis">
                  ...
                  chúng bị động và dồn vào thế phải chiến đấu tại Điện Biên Phủ
                  — nơi Đảng và Chủ tịch Hồ Chí Minh đã lựa chọn làm điểm quyết
                  chiến chiến lược.
                </p>
              </div>
              ...
              <div className="leadership-card">
                ...
                <p>
                  Trong quá trình chỉ đạo, Đảng thể hiện bản lĩnh, trí tuệ vượt
                  trội khi kịp thời thay đổi phương châm tác chiến:
                </p>
              ...
              <div className="leadership-card">
                ...
                <p className="conclusion">
                  Hậu phương lớn mạnh là điểm tựa vững chắc cho tiền tuyến, thể
                  hiện năng lực lãnh đạo toàn diện của Đảng – không chỉ trên
                  chiến trường, mà còn trong xây dựng tinh thần đoàn kết và niềm
                  tin chiến thắng của toàn dân.
                </p>
              </div>
            </div>
            ...
            <div className="final-message">
              ...
              <p className="highlight-conclusion">
                Chính sức mạnh ấy –{" "}
                <strong>
                  sức mạnh của Đảng, của niềm tin, của trí tuệ và bản lĩnh Việt
                  Nam
                </strong>{" "}
                – đã làm nên chiến thắng Điện Biên Phủ "lừng lẫy năm châu, chấn
                động địa cầu", khẳng định vai trò lãnh đạo của Đảng là nguồn gốc
                sâu xa và quyết định của mọi thắng lợi cách mạng Việt Nam.
              </p>
            </div>
            ...
            <div className="vnr-connection">
              ...
              <p>
                ...
                tầm nhìn, trí tuệ và bản lĩnh để lãnh đạo cách mạng Việt Nam đi
                từ thắng lợi này đến thắng lợi khác, thực hiện thành công sự
